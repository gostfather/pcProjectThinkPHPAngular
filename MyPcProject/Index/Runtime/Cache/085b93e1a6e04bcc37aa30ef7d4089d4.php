			...
			<div class="nc-login">
				...
				<div class="nc-login-content" id="demo-form-site">
					<form id="login_form" method="post" action="index.php?act=login&amp;op=login" class="bg">
						<input type="hidden" name="formhash" value="pGdF8N3xKl_-XntyiZepydOAUxgsFAi"> <input type="hidden" name="form_submit" value="ok">
						<input name="nchash" type="hidden" value="74c75179">
						<dl>
							<dt>用户名</dt>
						...
						<dl>
							...
							<dd style="min-height:54px;">
								...
								<img src="http://www.531314.com/index.php?act=seccode&amp;op=makecode&amp;nchash=74c75179" name="codeimage" border="0" id="codeimage" class="fl ml5">
								<a href="javascript:void(0)" class="ml5" onclick="javascript:document.getElementById('codeimage').src='http://www.531314.com/index.php?act=seccode&amp;op=makecode&amp;nchash=74c75179&amp;t=' + Math.random();">看不清，换一张</a>
								<label></label>
							</dd>
						</dl>
						<dl>
							...
							<dd>
								...
								<input type="hidden" value="http://531314.com/" name="ref_url">
							</dd>
						</dl>
					</form>
					<dl class="mt10 mb10">
						<dt>&nbsp;</dt>
						<dd>还不是本站会员？立即
							<a title="" href="index.php?act=login&amp;op=register&amp;ref_url=http%3A%2F%2F531314.com%2F" class="register">注册</a>
						</dd>
					</dl>
				</div>
				...
				$("#login_form").validate({
					...
					rules: {
						...
						captcha: {
							required: true,
							remote: {
								url: 'http://www.531314.com/index.php?act=seccode&op=check&nchash=74c75179',
								type: 'get',
								data: {
									captcha: function() {
										return $('#captcha').val();
								...
								complete: function(data) {
									if(data.responseText == 'false') {
										document.getElementById('codeimage').src = 'http://www.531314.com/index.php?act=seccode&op=makecode&nchash=74c75179&t=' + Math.random();
									}
								}
							}
						}
