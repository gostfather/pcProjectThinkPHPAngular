			...
			<div class="right-layout">
				<div class="wrap">
					...
					<table ng-app="app" ng-controller="myCon" class="ncm-default-table order">
						...
						<tbody ng-repeat="(k,v) in orders" class="pay">
							<tr>
								<td colspan="19" class="sep-row"></td>
							</tr>
							<tr>
								<td colspan="19" class="pay-td"><span class="ml15">在线支付金额：<em>￥{{v.totalmoney}}</em></span>
									<a class="ncm-btn ncm-btn-orange fr mr15"><i class="icon-shield"></i>订单支付</a>
								</td>
							</tr>
							<tr>
								<th colspan="19">
							...
							<tr>
								...
								<td class="w70">
									<div class="ncm-goods-thumb">
										<a><img ng-src="{{v.shops[0].imgurl}}" /></a>
									</div>
								</td>
								<td class="tl">
									<dl class="goods-name">
								...
								<td class="bdl bdr" rowspan="{{v.shops.length}}">
									<p>
										<a ng-click="delOrder(v.ordernumber)" class="ncm-btn ncm-btn-red"><i class="icon-ban-circle"></i> 取消订单</a>
									</p>
								</td>
							</tr>
						...
						<tbody ng-repeat="(k,v) in orders">
							...
							<tr>
								<th colspan="19">
									...
									<span member_id="1"></span>
									<a class="share-goods"><i class="icon-share"></i>分享</a>
									<a class="order-trash"><i class="icon-trash"></i>删除</a>
								</th>
							</tr>
							<tr>
								<td class="bdl"></td>
