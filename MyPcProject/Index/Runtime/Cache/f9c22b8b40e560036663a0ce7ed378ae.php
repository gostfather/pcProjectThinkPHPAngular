...
<nav class="public-nav-layout">
	...
	<ul id="fullScreenSlides" class="full-screen-slides">
		<li><a href="http://www.531314.com/shop/index.php?act=zt&amp;op=valentine"><img src="__ROOT__/Index/Common/images/editor/web-101-101-3.jpg?180" alt="" /></a></li>
		<li><a href="http://www.531314.com/shop/cate-1074-0-0-0-0-0-0-0-0.html"><img src="__ROOT__/Index/Common/images/editor/web-101-101-2.jpg?163" alt="" /></a></li>
		<li><a href="http://www.531314.com/item-100942.html"><img src="__ROOT__/Index/Common/images/editor/web-101-101-1.jpg?806" alt="" /></a></li>
	</ul>	
...
<script>
	$(function(){
		var length = $(".full-screen-slides li").length;
		$(".full-screen-slides li").first().show();
		var i = 0;
		...
		function move(){
			...
			if(i==length) 
				i = 0;
			$(".full-screen-slides li").eq(i).fadeIn(1000).siblings().fadeOut(1000);		
		}
	})
</script>
	...
	<div class="left-layout">
		...
		<div class="tabs-panel sale-goods-list" ng-controller="myCon4">
			<ul>			
				<li ng-cloak class="item" ng-repeat="(k,v) in data">
					<dl>
						<dt class="goods-name">
						...
						<dd class="goods-price">
							商城价：<em class="sale-price" >&yen;{{v.StorePrice}}</em> 
						</dd>
					</dl>
				</li>
...
<script type="text/javascript">
	var data = <?php echo ($newarr); ?>;
	var app = angular.module("app",[]);
	app.controller("myCon4",function ($scope,$http) {
	...
	<div class="middle-layout" ng-controller="myCon1">
...
<script type="text/javascript">	
	var floor1 = <?php echo ($floor1); ?>;
	app.controller("myCon1",function ($scope,$http) {
		$scope.data = floor1.data;	
   });
	...
	<div class="middle-layout" ng-controller="myCon2">
		<div class="tabs-panel middle-goods-list ">
			<ul>			
				<li ng-cloak class="item" ng-repeat="(k,v) in data" >
					<dl>
...
<script type="text/javascript">	
	var floor2 = <?php echo ($floor2); ?>;
	app.controller("myCon2",function ($scope,$http) {
		$scope.data = floor2.data;
   });
	...
	<div class="middle-layout" ng-controller="myCon3">
		<div class="tabs-panel middle-goods-list ">
			<ul>			
				<li ng-cloak class="item" ng-repeat="(k,v) in data" >
					<dl>
...
<script type="text/javascript">	
	...
	var floor3 = <?php echo ($floor3); ?>;
	app.controller("myCon3",function ($scope,$http) {
		$scope.data = floor3.data;
		setTimeout(function(){
			asdf();
		})
    });
